...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/prog.avanz_lab3-casodeuso1.exe

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/prog.avanz_lab3-casodeuso1.exe: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/prog.avanz_lab3-casodeuso1 ${OBJECTFILES} ${LDLIBSOPTIONS}
...
${OBJECTDIR}/CU8.o: CU8.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CU8.o CU8.cpp
...
${OBJECTDIR}/DataPartidasUnidas.o: DataPartidasUnidas.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DataPartidasUnidas.o DataPartidasUnidas.cpp
