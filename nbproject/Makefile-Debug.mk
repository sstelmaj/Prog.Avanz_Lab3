...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/prog.avanz_lab3-casodeuso_1-2_.exe

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/prog.avanz_lab3-casodeuso_1-2_.exe: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/prog.avanz_lab3-casodeuso_1-2_ ${OBJECTFILES} ${LDLIBSOPTIONS}
...
${OBJECTDIR}/CU2.o: CU2.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CU2.o CU2.cpp
...
${OBJECTDIR}/Controlador_Autenticacion.o: Controlador_Autenticacion.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Controlador_Autenticacion.o Controlador_Autenticacion.cpp

${OBJECTDIR}/Controlador_Desarrollador.o: Controlador_Desarrollador.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Controlador_Desarrollador.o Controlador_Desarrollador.cpp

${OBJECTDIR}/Controlador_Jugador.o: Controlador_Jugador.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Controlador_Jugador.o Controlador_Jugador.cpp

${OBJECTDIR}/DataComentario.o: DataComentario.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DataComentario.o DataComentario.cpp

${OBJECTDIR}/DataJuegos.o: DataJuegos.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DataJuegos.o DataJuegos.cpp
...
${OBJECTDIR}/DataUsuario.o: DataUsuario.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DataUsuario.o DataUsuario.cpp

${OBJECTDIR}/DataVideojuegoCU11.o: DataVideojuegoCU11.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DataVideojuegoCU11.o DataVideojuegoCU11.cpp

${OBJECTDIR}/DataVideojuegosCU5.o: DataVideojuegosCU5.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DataVideojuegosCU5.o DataVideojuegosCU5.cpp

${OBJECTDIR}/DtDate.o: DtDate.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DtDate.o DtDate.cpp

${OBJECTDIR}/DtPartidasSinTerminar.o: DtPartidasSinTerminar.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DtPartidasSinTerminar.o DtPartidasSinTerminar.cpp

${OBJECTDIR}/DtTime.o: DtTime.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DtTime.o DtTime.cpp

${OBJECTDIR}/Estadistica.o: Estadistica.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Estadistica.o Estadistica.cpp
...
${OBJECTDIR}/Suscripcion.o: Suscripcion.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Suscripcion.o Suscripcion.cpp
...
${OBJECTDIR}/Videojuego.o: Videojuego.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Videojuego.o Videojuego.cpp
