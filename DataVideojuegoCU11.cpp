...
DataVideojuegoCU11::DataVideojuegoCU11(string _descripcion, float _costopermanente, float _costomensual, string _empresa, float _promediopuntaje, ICollection* categoria) {
