...
void AbandonarPartidaMultijugador(){
    ...
    if(partida != NULL){
        IIterator* it = fabrica->getInterfacejugador()->ListarPartidasUnidas()->getIteratorObj();
        ...
        while(it->hasNext()){
            ...
            cout<<"Fecha -> "; dp->getFecha()->toString(); cout<<endl;
            cout<<"Hora -> "; dp->getHora()->toString(); cout<<endl;
            ...
            IIterator* iter = dp->getNicknameUnidos()->getIteratorObj();
